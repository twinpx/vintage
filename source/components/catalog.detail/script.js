( function($) {
  ...
  $( function() {
    ...
    $( 'body' ).delegate( '#individualOrderBg, #individualOrderBg .b-img-close', 'click', function() {
      $( '#individualOrderBg' ).remove();
    });
    ...
    $( '#individualOrder' ).delegate( 'form', 'submit', function(e) {
      ...
      e.preventDefault();
      var $form = $( this );
      var $body = $( '#individualOrder .modal-body' );
      ...
      $.ajax({
        ...
        success: function(data) {
          if ( data && data.MESSAGE ) {
            ...
            $body.addClass( 'i-success' ).find( '.b-success .text-center' ).html( data.MESSAGE );
            //$body.empty().append( '<p class="text-center">' + data.MESSAGE + '</p>' );
            $body.height( $body.find( 'p' ).height());
            
            $( '#individualOrder .modal-footer .btn' ).hide();
            $( '#individualOrder .modal-footer .i-gray' ).show();
          }
        },
        error: function( a,b,c ) {
          console.log(a);
